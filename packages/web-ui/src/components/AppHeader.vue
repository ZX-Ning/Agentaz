          ...
          <div class="space-y-1">
            <div class="space-y-2 px-3 py-2">
              ...
              <div class="space-y-2 text-sm">
                ...
                <div class="flex items-center justify-between gap-3">
                  <span class="flex items-center gap-2 text-muted-foreground">
                    <AppIcon name="i-lucide-layers" class="size-4" />
                    Queue
                  </span>
                  <span
                ...
                <div class="flex items-center justify-between gap-3">
                  <span class="flex items-center gap-2 text-muted-foreground">
                    <AppIcon name="i-lucide-shield-alert" class="size-4" />
                    Approvals
                  </span>
                  <span
                    class="font-sans text-xs font-medium text-muted-foreground"
                ...
                <div class="flex items-center justify-between gap-3">
                  <span class="flex items-center gap-2 text-muted-foreground">
                    <AppIcon name="i-lucide-cpu" class="size-4" />
                    Models
                  </span>
                  <span
                    class="font-sans text-xs font-medium text-muted-foreground"
            ...
            <button
              ...
              @click="toggleAutoStickToBottom"
            >
              <AppIcon name="i-lucide-arrow-down-to-line" class="size-4" />
            ...
            >
              <AppIcon name="i-lucide-log-out" class="size-4" />
              <span>Log out</span>
            </button>
          </div>
        </template>
