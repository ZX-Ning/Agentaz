...
const sizeClass = computed(() => {
    if (props.size === "xs") return "h-7 gap-1.5 px-2 text-xs";
    if (props.size === "sm") return "h-8 gap-1.5 px-3 text-sm";
    if (props.size === "lg") return "h-10 px-6";
    if (props.size === "icon") return "size-9 p-0";
